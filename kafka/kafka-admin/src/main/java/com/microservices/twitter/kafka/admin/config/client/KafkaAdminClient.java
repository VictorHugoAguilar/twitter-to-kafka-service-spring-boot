package com.microservices.twitter.kafka.admin.config.client;

import com.microservices.twitter.kafka.admin.exception.KafkaClientException;
import com.microservices.twitter.to.kafka.service.config.KafkaConfigData;
import com.microservices.twitter.to.kafka.service.config.RetryConfigData;
...
public class KafkaAdminClient {
    ...
    private void sleep(Long sleepTimeMs) {
        try {
            ...
            throw new KafkaClientException("Error while sleeping for waiting new created topics!!", i);
        }
    }
